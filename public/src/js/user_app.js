function viewIndex(){
  var url = 'https://manuel-salinas.com/api/users';
...
function viewUser(who){
  ...
  var url = 'https://manuel-salinas.com/api/users/view/' + who;
  ...
  xhr.onload = function(){
    ...
    editUser.addEventListener('submit', function(e){
      ...
      var url = 'https://manuel-salinas.com/api/users/edit';
...
function createUser(){
  ...
  createUser.addEventListener('submit', function(e){
    ...
    var url = 'https://manuel-salinas.com/api/users/create';
...
function deleteUser(userId){
  ...
  if (window.confirm("Are you sure you want to delete this user?")) {
    ...
    var url = 'https://manuel-salinas.com/api/users/delete/' + userId;
